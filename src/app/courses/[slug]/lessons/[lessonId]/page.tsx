                    ...
                    <div className={`flashcard-card aspect-[10/12] sm:aspect-[10/11] max-h-[calc(100vh-260px)] ${flipped ? "flipped" : ""}`}>
                      ...
                      <div className="flashcard-face bg-white border border-gray-100 shadow-[0_4px_24px_rgba(0,0,0,0.06)] p-[20px] sm:p-[28px] md:p-[36px] flex flex-col items-center text-center">
                        ...
                        <button
                          ...
                          className={`w-[36px] h-[36px] sm:w-[40px] sm:h-[40px] rounded-full flex items-center justify-center shadow-[0_2px_8px_rgba(245,166,35,0.3)] hover:scale-110 active:scale-95 transition-all duration-200 mb-[20px] ${words[practiceIndex].audio ? "bg-gradient-to-br from-[#f5a623] to-[#e8932b]" : "bg-gray-200"}`}
                        >
                        ...
                        {/* Hanzi */}
                        <h2 className="text-[32px] sm:text-[40px] md:text-[48px] font-bold text-[#1a1a2e] leading-none mb-[14px]">
                          {words[practiceIndex].hanzi}
                        </h2>

                        {/* Pinyin */}
                        <p className="text-[15px] sm:text-[17px] md:text-[19px] text-[#e8632b] font-medium italic mb-[16px]">
