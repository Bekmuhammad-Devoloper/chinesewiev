...
export default function LessonsList({ slug, lessons }: { slug: string; lessons: Lesson[] }) {
      ...
      {lessons.map((lesson) => {
        ...
        const cardContent = (
          <>
            ...
            <div className="flex flex-col gap-[6px] px-[8px] sm:px-[10px] md:px-[12px] lg:px-[14px] xl:px-[16px] py-[12px] sm:py-[14px] md:py-[16px] lg:py-[18px] xl:py-[20px]">
