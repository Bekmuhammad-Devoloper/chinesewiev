...
const lessons = [
  {
    ...
    circleIcon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={circleIconCls}>
        <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
      </svg>
    ),
    titleIcon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={titleIconCls}>
        <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
      </svg>
    ),
  },
      ...
      <div className="max-w-[1920px] mx-auto px-[16px] md:px-[60px] lg:px-[156px]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 gap-[10px] md:gap-[18px] lg:gap-[22px]">
          {lessons.map((lesson) => (
            <div
              key={lesson.number}
              className="bg-accent rounded-[12px] md:rounded-[18px] lg:rounded-[20px] p-[14px] md:p-[28px] lg:p-[35px] flex flex-col justify-between min-h-[160px] md:min-h-[260px] lg:min-h-[300px]"
            >
