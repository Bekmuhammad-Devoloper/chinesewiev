  ...
  return (
    <section id="hero" className="bg-primary">
      ...
      <div className="flex flex-col max-w-[1920px] mx-auto pt-[44px] md:pt-[72px] lg:min-h-screen lg:pt-[90px]">
        ...
        <div className="flex flex-col items-center justify-center px-[20px] md:px-8 lg:px-[76px] gap-[8px] md:gap-[10px] lg:gap-[14px] pt-[20px] md:pt-[40px] lg:pt-0 pb-[40px] md:pb-[60px] lg:pb-[30px] lg:flex-1">
          {/* Logo */}
          <Image
            src="/assets/logo.png"
            alt="Chinese Wave"
