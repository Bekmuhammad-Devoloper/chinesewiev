  ...
  return (
    <section id="courses" className="bg-primary pt-[30px] md:pt-[90px] lg:pt-[100px]">
      <div className="max-w-[1920px] mx-auto px-[16px] md:px-[60px] lg:px-[156px]">
        <h2 className="text-gold font-bold text-[22px] md:text-[48px] lg:text-[60px] leading-[1.15] text-center mb-[16px] md:mb-[40px] lg:mb-[50px]">
          Darsliklar
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[14px] md:gap-[24px] lg:gap-[30px]">
          {courses.map((course) => (
            <div
              key={course.title}
              className="bg-accent rounded-[16px] md:rounded-[20px] flex flex-col"
            >
              {/* Image with padding */}
              ...
              <div className="px-[16px] md:px-[22px] lg:px-[28px] pt-[16px] md:pt-[22px] lg:pt-[28px] pb-[16px] md:pb-[22px] lg:pb-[28px] flex flex-col flex-1">
                <h3 className="text-gold font-bold text-[18px] md:text-[24px] lg:text-[30px] leading-[1.2] mb-[10px] md:mb-[14px] text-center">
                  {course.title}
                </h3>
                <ul className="space-y-[4px] md:space-y-[6px] text-gold text-[11px] md:text-[13px] lg:text-[15px] font-normal leading-[1.55] flex-1">
